...
## Confirmatory Analyses on Active Localization

For completeness, we also conducted the same one way ANOVA to test the effect of group on active localization changes.
...
Results from these follow-up comparisons show that only the Hand View group significantly differed from mean active localization shifts from the Non-Instructed group. Given that shifts in active localization are informed by changes in both proprioception and predictions, this supports our finding that, although shifts in proprioceptive estimates of hand location persisted across all groups, only the Hand View group showed reduced changes in updating of predicted sensory consequences.
